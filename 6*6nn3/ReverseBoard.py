...
class ReverseBoard:
    def __init__(self):
        """ Constructor """
        # ボード初期化
        self._stone_status = [[ReverseCommon.NONE for i in range(6)] for j in range(6)]
        self._stone_status[2][2] = ReverseCommon.WHITE
        self._stone_status[3][3] = ReverseCommon.WHITE
        self._stone_status[2][3] = ReverseCommon.BLACK
        self._stone_status[3][2] = ReverseCommon.BLACK
        # 黒のターンに初期化

...
class ReverseBoard:
    def __init__(self):
        """ Constructor """
        # ボード初期化
        self._stone_status = [[ReverseCommon.NONE for i in range(8)] for j in range(8)]
        self._stone_status[3][3] = ReverseCommon.WHITE
        self._stone_status[4][4] = ReverseCommon.WHITE
        self._stone_status[3][4] = ReverseCommon.BLACK
        self._stone_status[4][3] = ReverseCommon.BLACK
        # 黒のターンに初期化
